    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item){
        switch (item.getItemId()){
            case R.id.mFile:
                ...
                break;
            case R.id.mEmail:
                Toast.makeText(MainActivity.this, "Select email address: ", Toast.LENGTH_SHORT).show();
                break;
            case R.id.mPhone:
                Toast.makeText(MainActivity.this,"Select phone number: ", Toast.LENGTH_SHORT).show();
                break;
        }
